...
%c% -I.. -I../.. -I../../colamd -I../../shared /LD /MT /O2 /Zp8 /Gz -D_WINDLL -D_USRDLL -DWIN32 -DRoleIsExternalInvEngine -DINVERSE_ACTIVE=INVERSE_ETAPFI -D_CRT_SECURE_NO_DEPRECATE %src% /Febin\%PLATFORM%\bfp_etaPFI.dll
...
rem mt /outputresource:"bin\%PLATFORM%\bfp_etaPFI.dll;#2" /manifest "bin\%PLATFORM%\bfp_etaPFI.dll.manifest"
